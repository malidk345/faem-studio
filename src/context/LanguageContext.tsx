...
const translations = {
  tr: {
    ...
    'home.hero_1_title': 'İpek\nAnlatısı',
    'home.hero_1_sub': 'Yaz 26 — Sessizlik ve ışıktan dokundu.',
    ...
    'shop.all_categories': 'Tüm Parçalar',
    ...
    'info.shipping_desc': '200$ üzerindeki tüm siparişlerde dünya çapında ücretsiz kargo. 2–4 iş günü.',
    'info.returns_title': 'Kusursuz İade',
    'info.returns_desc': '30 gün içinde iade veya değişim. Kuryemiz kapınızdan teslim alsın.',
    'info.quality_title': 'Kalite Garantisi',
    'info.quality_desc': 'Her parça iki kez kontrol edilir. İki yıllık sürdürülebilirlik garantisi kapsamındadır.',
    'product.price_label': 'Fiyat',
    'product.short_promise': '200$ üzeri ücretsiz kargo · 30 gün iade',
  ...
  en: {
    ...
    'home.hero_1_title': 'The Silk\nNarrative',
    'home.hero_1_sub': 'Summer 26 — Woven from silence and light.',
    ...
    'shop.all_categories': 'Filter All',
