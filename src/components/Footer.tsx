...
// ── Inline SVG Payment Icons (Turkish payment ecosystem) ──
const VisaIcon = () => (
...
const TamiIcon = () => (
  <svg viewBox="0 0 48 32" className="h-5 w-auto" fill="none">
    <rect width="48" height="32" rx="4" fill="#0035FF" />
    <text x="24" y="19" textAnchor="middle" fill="white" fontSize="9" fontWeight="900" fontFamily="Inter, sans-serif" letterSpacing="-0.5px">tami</text>
    <circle cx="38" cy="10" r="3" fill="#A7FF00" />
  </svg>
);
      ...
      <div className="max-w-[1100px] mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="text-xl font-bold tracking-tighter lowercase leading-none mb-3 block text-white">
              faem
            </Link>
