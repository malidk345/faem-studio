    ...
    <motion.div variants={containerVariants} className="menu-content h-full p-1 pt-2 pb-4">
      ...
      <div className="relative flex-1">
        <nav className="py-2">
          ...
          <motion.h3 variants={itemVariants} className="mt-4">Kurumsal</motion.h3>
          <motion.ul variants={itemVariants}>
            <li>
              <Link to="/legal/about" onClick={onClose}>
                <span>Hakkımızda</span>
              </Link>
            </li>
            <li>
              <Link to="/legal/privacy" onClick={onClose}>
                <span>Gizlilik Politikası</span>
              </Link>
            </li>
            <li>
              <Link to="/legal/returns" onClick={onClose}>
