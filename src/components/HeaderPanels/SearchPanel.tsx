  ...
  return (
    <motion.div variants={containerVariants} className="p-5 flex flex-col gap-4">
      ...
      <motion.div variants={itemVariants} className="mt-2">
        <p className="text-black/30 text-[10px] uppercase tracking-[0.2em] mb-3 font-bold">{t('search.popular')}</p>
        <div className="flex flex-wrap gap-2">
          {[t('nav.collection'), t('nav.new_arrivals'), t('nav.accessories')].map(term => (
