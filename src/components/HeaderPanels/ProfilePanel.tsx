        ...
        {!user ? (
          ...
          >
            <div className="flex flex-col items-center text-center pb-4 border-b border-black/5">
              ...
              <h3 className="text-black font-bold text-[18px]">Studio Access</h3>
              <p className="text-black/40 text-[13px] font-medium leading-relaxed max-w-[200px] mt-1">Sign in to securely access your personalized history.</p>
            </div>
